...
- Produces a summary report with risk flags, review readiness tiers, data quality tiers, GPA stats, income bracket mix, submission window, duplicate counts, and eligibility note tags.
...
- `output/normalized.json` with normalized rows + computed flags, review readiness tiers, and data quality scores.
- `output/summary.md` with a one-page intake snapshot, data quality tiers, and eligibility note tag counts.
