...
- Produces a summary report with risk flags, review readiness tiers, GPA stats, income bracket mix, submission window, duplicate counts, and eligibility note tags.
...
- `output/normalized.json` with normalized rows + computed flags and review readiness tiers.
